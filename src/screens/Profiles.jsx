    ...
    <div className="app has-tabbar">
      <div className="screen-scroll">
        ...
        <div className="pad-lg" style={{ paddingTop: 4 }}>
          ...
          {/* players I scout for (shown to scouts) */}
          {playersIScout.length > 0 && (
            <>
              <div style={{ fontSize: 11, color: 'var(--muted)', fontWeight: 700, letterSpacing: '.5px', margin: '0 2px 10px' }}>PLAYERS YOU SCOUT FOR</div>
              {playersIScout.map((l) => (
          ...
          {/* people linked to me */}
          <div style={{ fontSize: 11, color: 'var(--muted)', fontWeight: 700, letterSpacing: '.5px', margin: '6px 2px 10px' }}>LINKED TO YOU</div>
          {scoutsForMe.length === 0 && <div className="empty" style={{ margin: '0 0 12px' }}>No one linked yet. Share your code below.</div>}
          {scoutsForMe.map((l, i) => (
          ...
          {cloud && (
            <div className="card" style={{ marginTop: 12 }}>
              <div style={{ fontSize: 12.5, fontWeight: 800, marginBottom: 5 }}>Link to a player</div>
              <div style={{ fontSize: 10.5, color: 'var(--muted)', lineHeight: 1.5, marginBottom: 12 }}>
                Enter a player's code to scout for them.
              </div>
              <div className="row" style={{ gap: 8 }}>
